...
<form class="form-horizental" style="border: 1px solid #CCC;" action="{{ url('enlever/'.$ins->id) }}" method="post">
...
{{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-12 col-md-offset">
                            <span>
                                vous etes sur de rendre l'utilisateur <span style="font-size: 20px;">{{$ins->name}}</span> comme admin ?
                            </span>
            </div>  
            <div class="col-md-12 col-md-offset">
